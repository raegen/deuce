define(['page', 'router'], function (Page, router) {
    ...
    form.addEventListener('input', function () {
        ...
        page.element.querySelector('#playOuter').href = 'play/' + data.get('username') + '/' + data.get('difficulty');
        page.element.querySelector('#playOuter').setAttribute('href', 'play/' + data.get('username') + '/' + data.get('difficulty'));
    });
